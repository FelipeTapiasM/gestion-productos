<x-app-layout>
    ...
    <div style="display:flex;align-items:center;gap:8px;font-size:13px;color:#94a3b8;margin-bottom:20px;">
        ...
        <span>›</span>
        <span style="color:#0f172a;font-weight:500;">Nuevo usuario</span>
    </div>
            ...
            <form method="POST" action="{{ route('users.store') }}">
                ...
                <div style="margin-bottom:18px;">
                    ...
                    <input type="password" name="password" placeholder="Mínimo 8 caracteres"
                           style="width:100%;height:42px;border:1.5px solid {{ $errors->has('password') ? '#fca5a5' : '#e2e8f0' }};
                               border-radius:8px;padding:0 14px;font-size:14px;color:#0f172a;background:#f8fafc;outline:none;">
                ...
                <div style="margin-bottom:18px;">
                    ...
                    <input type="password" name="password_confirmation" placeholder="Repite la contraseña"
                           style="width:100%;height:42px;border:1.5px solid #e2e8f0;
                               border-radius:8px;padding:0 14px;font-size:14px;color:#0f172a;background:#f8fafc;outline:none;">
                </div>
